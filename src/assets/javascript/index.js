...
$('#update-btn').on('click', function () {
    var $updateTxt = $('#update-txt').val();
    var regex = /(Url:).+/;
    var replaceText = document.getElementById('showmewhoiam').innerHTML;

    
    console.log($updateTxt);
    replaceText.replace(regex, "");
    var someshite = $('#showmewhoiam').text().match(/(Url:).+/g)
    $('h3').text().replace(/./, '')

    console.log($('#showmewhoiam').text().match(/(Url:).+/g));
